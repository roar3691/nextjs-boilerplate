        ...
        <section className="text-center py-12">
          ...
          <div className="flex space-x-4 justify-center">
            <a
              ...
              className="px-6 py-3 bg-black dark:bg-gray-800 text-white dark:text-gray-300 rounded-lg shadow-md hover:bg-gray-700 dark:hover:bg-gray-700 transition"
            >
              GitHub
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-3 bg-blue-600 dark:bg-blue-700 text-white dark:text-gray-300 rounded-lg shadow-md hover:bg-blue-500 dark:hover:bg-blue-500 transition"
            >
              LinkedIn
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-3 bg-yellow-500 dark:bg-yellow-600 text-white dark:text-gray-300 rounded-lg shadow-md hover:bg-yellow-400 dark:hover:bg-yellow-500 transition"
            >
              Resume
            </a>
          </div>
